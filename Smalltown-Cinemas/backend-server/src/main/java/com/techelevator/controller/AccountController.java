...
public class AccountController {
    ...
    @GetMapping(path = "/api/getUserId/{username}")
    public int getUserId(@PathVariable String username) {
    	return (int) user.getUserByUsername(username).getId();
    }
    
//    @RequestMapping(path = "Account-Info/change", method = RequestMethod.PUT)
